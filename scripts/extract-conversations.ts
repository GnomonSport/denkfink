 ...
 *   ELEVENLABS_API_KEY, SUPABASE_URL, SUPABASE_SERVICE_ROLE_KEY, ELEVENLABS_AGENT_ID
 *
...
// AGENT_ID is loaded below from apps/backend/.env (key: ELEVENLABS_AGENT_ID).
...
const AGENT_ID = backendEnv.ELEVENLABS_AGENT_ID || tabletEnv.VITE_ELEVENLABS_AGENT_ID || process.env.ELEVENLABS_AGENT_ID || '';

if (!ELEVENLABS_API_KEY) throw new Error('Missing ELEVENLABS_API_KEY');
if (!SUPABASE_URL) throw new Error('Missing SUPABASE_URL');
if (!SUPABASE_KEY) throw new Error('Missing SUPABASE_KEY');
if (!AGENT_ID) throw new Error('Missing ELEVENLABS_AGENT_ID (set in apps/backend/.env)');
